/**
 * @filename S4Touch_TLpP5-mT3-pR001_LadLine_BufOff.js
 * @description فروش در برخورد و بازگشت قیمت از یک خط روند نزولی (مقاومت) — ورود روی لمس و بازگشت خط، نه شکست آن. pivotPeriod=5، minTouchPoints=3، precision=0.001 | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = خطی پویا (Dynamic-Linear)، بافر غیرفعال (enableSmartContinuation: false)
 */
...
function customStrategy(data, index, breakPointsParam, _ichimokuUnused, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_S4Touch_TLpP5_mT3_pR001_LadLine_BufOff || globalThis.__state_S4Touch_TLpP5_mT3_pR001_LadLine_BufOff.dataRef !== data) {
    globalThis.__state_S4Touch_TLpP5_mT3_pR001_LadLine_BufOff = { dataRef: data, lastTouchIndex: {} };
  }
  const st = globalThis.__state_S4Touch_TLpP5_mT3_pR001_LadLine_BufOff;

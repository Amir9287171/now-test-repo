/**
 * @filename 
 * @description خرید با تایید ایچیموکو (14,30,57)، شکست خط روند نزولی، RSI بالای ۵۰، فیلتر روند صعودی (قیمت بالای EMA50)، حد ضرر اولیه ۰.۴٪، و حد ضرر پلکانی ۳۵ مرحله‌ای تا ۵۰٪
 * @version 3.0
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam) {
    ...
    // ------------------------------------------------------------
    // ۴. دریافت خطوط روند و فیلتر خطوط نزولی
    // ------------------------------------------------------------

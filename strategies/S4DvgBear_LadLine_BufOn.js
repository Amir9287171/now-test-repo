/**
 * @filename S4DvgBear_LadLine_BufOn.js
 * @description فروش فقط بر اساس سیگنال واگرایی نزولی (Regular یا Hidden) روی RSI/MACD — بدون هیچ شرط دیگری | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = خطی پویا (Dynamic-Linear)، بافر فعال (enableSmartContinuation: true)
 */

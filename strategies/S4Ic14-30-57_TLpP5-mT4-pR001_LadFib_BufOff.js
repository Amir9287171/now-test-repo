/**
 * @filename S4Ic14-30-57_TLpP5-mT4-pR001_LadFib_BufOff.js
 * @description فروش با تایید ایچیموکو (14,30,57)، حد ضرر 0.4%، خط روند با pivotPeriod=5، minTouchPoints=4، precision=0.001 | اصلاح‌شده: حد سود حذف شد، حد ضرر پلکانی = فیبوناچی تعدیل‌شده (Adjusted-Fibonacci)، بافر غیرفعال (enableSmartContinuation: false)
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_S4Ic14_30_57_TLpP5_mT4_pR001_LadFib_BufOff || globalThis.__state_S4Ic14_30_57_TLpP5_mT4_pR001_LadFib_BufOff.dataRef !== data) {
    globalThis.__state_S4Ic14_30_57_TLpP5_mT4_pR001_LadFib_BufOff = { dataRef: data, brokenLines: new Set() };
  }
  const brokenLines = globalThis.__state_S4Ic14_30_57_TLpP5_mT4_pR001_LadFib_BufOff.brokenLines;

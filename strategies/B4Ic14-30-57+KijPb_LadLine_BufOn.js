/**
 * @filename B4Ic14-30-57+KijPb_LadLine_BufOn.js
 * @description خرید پول‌بک در روند صعودی ایچیموکو (14,30,57): وقتی روند کلی صعودی است (قیمت بالای ابر، تنکان بالای کیجون) ولی کندل تا نزدیکی خط کیجون‌سن پایین می‌آید و دوباره بالای آن بسته می‌شود | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = خطی پویا (Dynamic-Linear)، بافر فعال (enableSmartContinuation: true)
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_B4Ic14_30_57_KijPb_LadLine_BufOn || globalThis.__state_B4Ic14_30_57_KijPb_LadLine_BufOn.dataRef !== data) {
    globalThis.__state_B4Ic14_30_57_KijPb_LadLine_BufOn = { dataRef: data, lastSignalIndex: -999 };
  }
  const st = globalThis.__state_B4Ic14_30_57_KijPb_LadLine_BufOn;

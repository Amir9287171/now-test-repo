/**
 * @filename B4Touch_TLpP5-mT3-pR001_LadLine_BufOff.js
 * @description خرید در برخورد و بازگشت قیمت از یک خط روند صعودی (حمایت) — بر خلاف استراتژی‌های شکست، اینجا ورود دقیقاً روی لمس و بازگشت خط انجام می‌شود، نه شکست آن. pivotPeriod=5، minTouchPoints=3، precision=0.001 | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = خطی پویا (Dynamic-Linear)، بافر غیرفعال (enableSmartContinuation: false)
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_B4Touch_TLpP5_mT3_pR001_LadLine_BufOff || globalThis.__state_B4Touch_TLpP5_mT3_pR001_LadLine_BufOff.dataRef !== data) {
    globalThis.__state_B4Touch_TLpP5_mT3_pR001_LadLine_BufOff = { dataRef: data, lastTouchIndex: {} };
  }
  const st = globalThis.__state_B4Touch_TLpP5_mT3_pR001_LadLine_BufOff;

/**
 * @filename B4Ic14-30-57_TLpP5-mT4-pR001_BrT012.js
 * @description خرید با تایید ایچیموکو (14,30,57)، حد ضرر 0.4%، خط روند با pivotPeriod=5، minTouchPoints=4، precision=0.001، و انتخاب شکست نزدیک به 0.12%
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_B4Ic14_30_57_TLpP5_mT4_pR001_BrT012 || globalThis.__state_B4Ic14_30_57_TLpP5_mT4_pR001_BrT012.dataRef !== data) {
    globalThis.__state_B4Ic14_30_57_TLpP5_mT4_pR001_BrT012 = { dataRef: data, brokenLines: new Set() };
  }
  const brokenLines = globalThis.__state_B4Ic14_30_57_TLpP5_mT4_pR001_BrT012.brokenLines;

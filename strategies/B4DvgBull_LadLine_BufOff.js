/**
 * @filename B4DvgBull_LadLine_BufOff.js
 * @description خرید فقط بر اساس سیگنال واگرایی صعودی (Regular یا Hidden) روی RSI/MACD — بدون هیچ شرط دیگری (بدون خط روند، بدون ایچیموکو) | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = خطی پویا (Dynamic-Linear)، بافر غیرفعال (enableSmartContinuation: false)
 */

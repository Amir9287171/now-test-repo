/**
 * @filename S4Ic14-30-57+KijPb_LadFib_BufOn.js
 * @description فروش پول‌بک در روند نزولی ایچیموکو (14,30,57): وقتی روند کلی نزولی است (قیمت زیر ابر، تنکان زیر کیجون) ولی کندل تا نزدیکی خط کیجون‌سن بالا می‌رود و دوباره زیر آن بسته می‌شود | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = فیبوناچی تعدیل‌شده (Adjusted-Fibonacci)، بافر فعال (enableSmartContinuation: true)
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_S4Ic14_30_57_KijPb_LadFib_BufOn || globalThis.__state_S4Ic14_30_57_KijPb_LadFib_BufOn.dataRef !== data) {
    globalThis.__state_S4Ic14_30_57_KijPb_LadFib_BufOn = { dataRef: data, lastSignalIndex: -999 };
  }
  const st = globalThis.__state_S4Ic14_30_57_KijPb_LadFib_BufOn;

/**
 * @filename B4DvgBull_PP12Macd.js
 * @description BUY با تایید واگرایی صعودی خالص (بدون خط روند/ایچیموکو).
 *   اندیکاتور(ها): MACD | نوع سیگنال پذیرفته‌شده: Regular و Hidden هردو
 *   مثل باین اصلی ولی به‌جای RSI از MACD استفاده می‌کند (بقیه‌ی پارامترها که به RSI مربوط نیستند ثابت مانده‌اند). مقایسه‌اش با باین اصلی، اثر خالص «انتخاب اندیکاتور» را جدا می‌کند.

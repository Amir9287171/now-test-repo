/**
 * @filename S4Touch+DvgBear_TLpP5-mT3-pR001_LadFib_BufOn.js
 * @description فروش فقط زمانی که هم‌زمان (۱) قیمت یک خط روند نزولی را لمس و از آن بازگشت کند و (۲) واگرایی نزولی روی همان کندل تایید شود | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = فیبوناچی تعدیل‌شده (Adjusted-Fibonacci)، بافر فعال (enableSmartContinuation: true)
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_S4Touch_DvgBear_TLpP5_mT3_pR001_LadFib_BufOn || globalThis.__state_S4Touch_DvgBear_TLpP5_mT3_pR001_LadFib_BufOn.dataRef !== data) {
    globalThis.__state_S4Touch_DvgBear_TLpP5_mT3_pR001_LadFib_BufOn = { dataRef: data, lastTouchIndex: {} };
  }
  const st = globalThis.__state_S4Touch_DvgBear_TLpP5_mT3_pR001_LadFib_BufOn;

/**
 * @filename B4DvgBull_PP8Rsi10Lb2Tol12.js
 ...
 *   مثل باینِ اصلی (PP12Rsi10Lb2Tol12) ولی PIVOT_PERIOD کوچک‌تر (۸ به‌جای ۱۲) — تعداد معاملات بیشتر ولی پیوت‌ها کمی کم‌اعتبارتر. مقایسه‌اش با باین اصلی نشان می‌دهد آیا PIVOT_PERIOD=12 واقعاً نقطه‌ی بهینه است یا هرچه بزرگ‌تر بهتر.

/**
 * @filename B4DvgBull_LadFib_BufOff.js
 * @description خرید فقط بر اساس سیگنال واگرایی صعودی (Regular یا Hidden) روی RSI/MACD — بدون هیچ شرط دیگری (بدون خط روند، بدون ایچیموکو) | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = فیبوناچی تعدیل‌شده (Adjusted-Fibonacci)، بافر غیرفعال (enableSmartContinuation: false)
 */

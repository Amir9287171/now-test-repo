/**
 * @filename B4DvgBull_PP12Rsi10Lb2Tol12.js
 ...
 *   بهترین ترکیب یافته‌شده در آزمایش‌های اکتشافی قبلی (روی داده‌ی کوتاه‌تر): فقط RSI (نه MACD)، PIVOT_PERIOD بزرگ‌تر (پیوت‌های محکم‌تر/کم‌نویزتر)، RSI_PERIOD کوتاه‌تر (واکنش سریع‌تر)، LOOKBACK_PIVOTS کم (فقط نزدیک‌ترین کاندیدها). این baseline اصلی برای بقیه‌ی مقایسه‌هاست.

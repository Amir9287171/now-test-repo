/**
 * @filename B4DvgBull_PP20Rsi10Lb2Tol12.js
 * @description BUY با تایید واگرایی صعودی خالص (بدون خط روند/ایچیموکو).
 *   اندیکاتور(ها): RSI | نوع سیگنال پذیرفته‌شده: Regular و Hidden هردو
 *   مثل باین اصلی ولی PIVOT_PERIOD بزرگ‌تر (۲۰). روی داده‌ی کوتاه، مقادیر خیلی بزرگ (۲۵-۳۰) با نمونه‌ی کم (زیر ۱۰ معامله) نتایج فریبنده دادند — روی ۷.۵ سال × ۵ نماد نمونه‌ی کافی برای قضاوت واقعی درباره‌ی PP=20 وجود دارد؛ اینجا واقعاً می‌شود فهمید نویز بود یا الگوی واقعی.

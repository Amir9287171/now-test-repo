/**
 * @filename B4DvgBull_PP12Rsi10Lb2Tol12_RegularOnly.js
 * @description BUY با تایید واگرایی صعودی خالص (بدون خط روند/ایچیموکو).
 *   اندیکاتور(ها): RSI | نوع سیگنال پذیرفته‌شده: فقط Regular
 *   مثل باین اصلی ولی فقط واگرایی‌های Regular (بازگشتی) قبول می‌شوند، نه Hidden. مکمل مستقیم نمونه‌ی قبلی (HiddenOnly) برای فهمیدن اینکه کدام دسته از سیگنال واگرایی واقعاً باکیفیت‌تر است.

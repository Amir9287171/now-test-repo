/**
 * @filename B4Touch_TLpP5-mT3-pR001_LadLine_BufOn.js
 * @description خرید در برخورد و بازگشت قیمت از یک خط روند صعودی (حمایت) — بر خلاف استراتژی‌های شکست، اینجا ورود دقیقاً روی لمس و بازگشت خط انجام می‌شود، نه شکست آن. pivotPeriod=5، minTouchPoints=3، precision=0.001 | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = خطی پویا (Dynamic-Linear)، بافر فعال (enableSmartContinuation: true)
 */
...
function customStrategy(data, index, breakPointsParam, _ichimokuUnused, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_B4Touch_TLpP5_mT3_pR001_LadLine_BufOn || globalThis.__state_B4Touch_TLpP5_mT3_pR001_LadLine_BufOn.dataRef !== data) {
    globalThis.__state_B4Touch_TLpP5_mT3_pR001_LadLine_BufOn = { dataRef: data, lastTouchIndex: {} };
  }
  const st = globalThis.__state_B4Touch_TLpP5_mT3_pR001_LadLine_BufOn;

/**
 * @filename B4Ic14-30-57_TLpP5-mT3-pR04_BrT012_LadLine_BufOff.js
 * @description خرید با تایید ایچیموکو (14,30,57)، حد ضرر 0.4%، خط روند با pivotPeriod=5، minTouchPoints=3، precision=0.04، و انتخاب شکست نزدیک به 0.12% | اصلاح‌شده: حد سود حذف شد، حد ضرر پلکانی = خطی پویا (Dynamic-Linear)، بافر غیرفعال (enableSmartContinuation: false)
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_B4Ic14_30_57_TLpP5_mT3_pR04_BrT012_LadLine_BufOff || globalThis.__state_B4Ic14_30_57_TLpP5_mT3_pR04_BrT012_LadLine_BufOff.dataRef !== data) {
    globalThis.__state_B4Ic14_30_57_TLpP5_mT3_pR04_BrT012_LadLine_BufOff = { dataRef: data, brokenLines: new Set() };
  }
  const brokenLines = globalThis.__state_B4Ic14_30_57_TLpP5_mT3_pR04_BrT012_LadLine_BufOff.brokenLines;

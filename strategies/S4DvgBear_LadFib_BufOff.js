/**
 * @filename S4DvgBear_LadFib_BufOff.js
 * @description فروش فقط بر اساس سیگنال واگرایی نزولی (Regular یا Hidden) روی RSI/MACD — بدون هیچ شرط دیگری | حد سود ممنوع (حذف شد)، خروج فقط با حد ضرر پلکانی = فیبوناچی تعدیل‌شده (Adjusted-Fibonacci)، بافر غیرفعال (enableSmartContinuation: false)
 */

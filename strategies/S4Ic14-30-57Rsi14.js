/**
 * @filename 
 * @description فروش با تایید ایچیموکو نزولی (14,30,57)، شکست خط روند صعودی از بالا به پایین، تأیید RSI زیر ۵۰، حد ضرر اولیه ۰.۴٪، و حد ضرر پلکانی ۳۵ مرحله‌ای تا ۵۰٪ (حداکثر اختلاف ۲٪)
 * @version 2.0
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam) {
    ...
    // ------------------------------------------------------------
    // ۲. محاسبه RSI با wickra (فقط تا index-1)
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // ۶. صدور سیگنال فروش با مدیریت ریسک کامل
    // ------------------------------------------------------------

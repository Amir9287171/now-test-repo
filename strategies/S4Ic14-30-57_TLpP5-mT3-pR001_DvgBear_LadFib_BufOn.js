/**
 * @filename S4Ic14-30-57_TLpP5-mT3-pR001_DvgBear_LadFib_BufOn.js
 * @description فروش با تایید ایچیموکو (14,30,57)، حد ضرر 0.4%، خط روند با pivotPeriod=5، minTouchPoints=3، precision=0.001، و تایید واگرایی نزولی (Bearish Divergence) | اصلاح‌شده: حد سود حذف شد، حد ضرر پلکانی = فیبوناچی تعدیل‌شده (Adjusted-Fibonacci)، بافر فعال (enableSmartContinuation: true)
 */
...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  if (!globalThis.__state_S4Ic14_30_57_TLpP5_mT3_pR001_DvgBear_LadFib_BufOn || globalThis.__state_S4Ic14_30_57_TLpP5_mT3_pR001_DvgBear_LadFib_BufOn.dataRef !== data) {
    globalThis.__state_S4Ic14_30_57_TLpP5_mT3_pR001_DvgBear_LadFib_BufOn = { dataRef: data, brokenLines: new Set() };
  }

  // اسنپ‌شات ایچیموکوی کندل قبلی برای جلوگیری از آینده‌نگری (lookahead bias)
  const __prevIchimoku = globalThis.__state_S4Ic14_30_57_TLpP5_mT3_pR001_DvgBear_LadFib_BufOn.__lastIchimokuIndex === index - 1 ? globalThis.__state_S4Ic14_30_57_TLpP5_mT3_pR001_DvgBear_LadFib_BufOn.__lastIchimoku : null;
  globalThis.__state_S4Ic14_30_57_TLpP5_mT3_pR001_DvgBear_LadFib_BufOn.__lastIchimoku = ichimokuParam ? { ...ichimokuParam } : null;
  globalThis.__state_S4Ic14_30_57_TLpP5_mT3_pR001_DvgBear_LadFib_BufOn.__lastIchimokuIndex = index;
  const brokenLines = globalThis.__state_S4Ic14_30_57_TLpP5_mT3_pR001_DvgBear_LadFib_BufOn.brokenLines;
